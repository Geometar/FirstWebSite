...
if(isset($_POST['email'])) {
    ...
    $email_subject = "Registracija fizickog lica";
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message .= "Ime: ".clean_string($all_name)."\n";
    $email_message .= "Adresa stanovanja: ".clean_string($last_name)."\n";
	$email_message .= "Pristup web portalu: ".implode(" ", $_POST['services'])."\n";
    $email_message .= "Email: ".clean_string($email_from)."\n";
    $email_message .= "Telefon: ".clean_string($telephone)."\n";
    $email_message .= "Licna karta: ".clean_string($licna_karta)."\n";
